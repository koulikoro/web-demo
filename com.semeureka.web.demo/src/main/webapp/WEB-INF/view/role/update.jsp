...
<tt:frame>
	...
	<form id="role-update" class="form-horizontal" action="${ctx}/role/update/${role.id}" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="description" rows="3" class="form-control" required pattern=".{6,255}">${role.description}</textarea>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<label class="checkbox-inline"><input name="permission" type="checkbox" value="user:update">添加</label>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<label class="checkbox-inline"><input name="permission" type="checkbox" value="organization:update">添加</label>
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				...
				<label class="checkbox-inline"><input name="permission" type="checkbox" value="role:update">添加</label>
